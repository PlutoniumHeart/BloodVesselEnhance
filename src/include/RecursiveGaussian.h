...
class CFilter: /*public CDiOps, */public CGPUMemOps
{
public:
	CFilter(void);
	~CFilter(void);
...
public:
	...
	void RecursiveGaussianFilter(int xDirection, int yDirection, int zDirection, T1* d_src, T2* d_dest, /*int order,*/ float sigma);
